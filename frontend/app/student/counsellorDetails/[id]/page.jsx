    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-white shadow-xl rounded-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-[#9810FA] h-48 flex items-center justify-center relative">
          ...
          <div className="pt-20 pb-8 px-6 md:px-10">
            ...
            <p className="text-lg text-[#9810FA] text-center mt-1">
              Academic Counsellor
            </p>

            {/* College Name - Highlighted */}
            <div className="text-center mt-4">
              <h2 className="text-2xl font-semibold text-[#9810FA] border-b-2 border-[#9810FA] inline-block px-4 pb-1">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-8 text-center">
              <div className="flex flex-col items-center">
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-xl font-bold">{dummyRating}</span>
                </div>
              ...
              <div className="flex flex-col items-center">
                <div className="flex items-center">
                  <Award className="h-5 w-5 text-[#9810FA]" />
                  <span className="ml-1 text-xl font-bold">
                    {dummyExperience}
                  </span>
                </div>
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-8">
                <div className="bg-white rounded-lg p-6 shadow-md border border-gray-100">
                  <h2 className="text-xl font-semibold text-[#9810FA] mb-6 pb-2 border-b border-gray-100">
                    Education Background
                  </h2>
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <School className="mr-4 h-6 w-6 text-[#9810FA] mt-1" />
                      <div>
                    ...
                    <div className="flex items-start">
                      <BookOpen className="mr-4 h-6 w-6 text-[#9810FA] mt-1" />
                      <div>
              ...
              <div className="space-y-8">
                <div className="bg-white rounded-lg p-6 shadow-md border border-gray-100">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <CreditCard className="mr-4 h-6 w-6 text-[#9810FA] mt-1" />
                      <div>
                    ...
                    {document.sessionDuration && (
                      <div className="flex items-start">
                        <Calendar className="mr-4 h-6 w-6 text-[#9810FA] mt-1" />
                        <div>
                          <h3 className="font-medium text-lg">
                            Session Duration
                          </h3>
                ...
                <div className="bg-white rounded-lg p-6 shadow-md border border-gray-100">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center px-4 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-[#9810FA] hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 w-full transition-all duration-200"
                  >
                    View ID Card
                  </button>
